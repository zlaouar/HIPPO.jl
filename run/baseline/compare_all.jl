...
greedysim = UnifiedBaselineSimulator(msim=pomdp, sinit=sinit, dt=1/10, max_iter=max_iter, display=display, verbose=verbose)
...
HIPPO.reset_pomdp!(mapsim, rewarddist, newtarget)
